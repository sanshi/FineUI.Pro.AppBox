...
{
    public class AppBoxDatabaseInitializer : DropCreateDatabaseIfModelChanges<AppBoxContext>  // DropCreateDatabaseAlways<FineUI.Pro.AppBoxContext>  DropCreateDatabaseIfModelChanges<FineUI.Pro.AppBoxContext>
    {
